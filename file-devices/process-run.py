...
class scheduler:
    def __init__(
        self, process_switch_behavior, io_done_behavior, io_length, interrupt_overhead
    ):
...
parser.add_option(
    ...
    "--interrupt_overhead",
    default=5,
    help="how long an interrupt processing takes",
    action="store",
    type="int",
    dest="interrupt_overhead",
)
parser.add_option(
    "-S",
    "--switch",
